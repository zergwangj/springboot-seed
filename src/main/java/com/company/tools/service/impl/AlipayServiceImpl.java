...
import com.company.tools.mapper.AlipayConfigMapper;
import com.company.tools.service.AlipayService;
import com.company.tools.util.AlipayUtils;
...
public class AlipayServiceImpl implements AlipayService {
    ...
    public AlipayConfig find() {
        Optional<AlipayConfig> alipayConfig = Optional.ofNullable(alipayConfigMapper.selectById(1L));
